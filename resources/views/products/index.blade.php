...
<div class="bg-white dark:bg-gray-900">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">Our Products</h1>
            <p class="mt-2 text-lg text-gray-600 dark:text-gray-400">Explore our collection of high-quality items</p>
        </div>
        ...
        @if($products->isEmpty())
            <div class="text-center py-16">
                ...
                <h2 class="mt-4 text-2xl font-semibold text-gray-900 dark:text-white">No Products Found</h2>
                <p class="mt-2 text-gray-600 dark:text-gray-400">Please check back later, we are always updating our collection!</p>
            </div>
        @else
                            ...
                            <div class="p-4">
                                ...
                                <div class="mb-2">
                                    @foreach($product->categories as $cat)
                                        <span class="inline-block bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-300 text-xs font-semibold px-2.5 py-0.5 rounded-full">{{ $cat->name }}</span>
                                    @endforeach
                                </div>
